...
{# For local
	$_CONFIG['site_url'] 		= "https://".$_SERVER['HTTP_HOST']."/rentacar/";
	$_CONFIG['site_path'] 		= $_SERVER['DOCUMENT_ROOT'] . "/rentacar/";
}
else if($_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "localhost:8080" || $_SERVER['HTTP_HOST'] == "14.141.114.205" || $_SERVER['HTTP_HOST'] == "10.100.65.117")
{# For local
	 $_CONFIG['site_url'] 		= "http://".$_SERVER['HTTP_HOST']."/RACP/";
	$_CONFIG['site_path'] 		= $_SERVER['DOCUMENT_ROOT'] . "/RACP/";
}
