...
function sendemail_b($subject, $message, $to) {
...
$mail->Password = "tgducvw@35962";
$mail->SetFrom("mussawar@egcpakistan.com", "Document Management System");
$mail->Subject = $subject;
$mail->Body = $message;
// Mail to single recipient
$mail->AddAddress($to);
// Mail to Multiple cc recipients
...
echo $to_b=$email;
echo $data_b="Hi User<br/>Your Activation Code is : ".$password;

$td = date('Y-m-d-h-m-s',time());
$subject_b="Activation Code - Rent a Car ";
sendemail_b($subject_b,$data_b,$to_b);
			
			$objCommon->setMessage("You have successfully registered. You will receive an activation code shortly.",'Error');	
 ...
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/css/bootstrap.min.css" rel="stylesheet"> 
     					...
     					<div class="mini_portfolio_item_title">
                        	<div class="block_title" align="center">
                               ...
                               // $company_result = $objSDb->dbQuery($copmany_sql);
								...
								?>
                                <div style="float:right; width:100%; text-align:right; margin-right:10px"> <a  href="index.php" class="button" >Back to Login Page</a></div>
       ...
       <div class="row"  style="margin-top: 20px;">
                ...
                <div class="col-md-2">
                    ...
                    <div class=" col-md-4 regular mobileclass2" style="font-size: small;">
                        <input class="form-control" type="file" name="al_file" id="al_file"  style="font-size: small;"  required>
             ...
             <div class="row"  style="margin-top: 20px;">
                ...
                <div class="col-md-2">
                    ...
                    <div class=" col-md-4 regular mobileclass2" style="font-size: small;">
                        <input class="form-control" type="file" name="al_file1" id="al_file1"  style="font-size: small;" required>
